...
def write_model(zealots):
    ...
    f.write("""ctmc
        ...
        // base rates
        const double qx = 0.01; //0.01; 0.002
        const double qy = 0.01; // 0.01; 
...
def consensus(majority, distance, transient, holding):
    dir_con = '/Users/juliaklein/Documents/consensus_robustness/inference_results/consensus_zealots_switch_new_('+str(majority)+','+str(distance)+','+str(transient)+','+str(holding)+')'
...
def analyse_probabilites():
    baseline = consensus(majority = 50, distance = 50, transient = 35, holding = 40)
    majority_lower = consensus(majority = 35, distance = 50, transient = 35, holding = 40)
    majority_higher = consensus(majority = 65, distance = 50, transient = 35, holding = 40)
    distance_lower = consensus(majority = 50, distance = 10, transient = 35, holding = 40)
    distance_higher = consensus(majority = 50, distance = 100, transient = 35, holding = 40)
    transient_lower = consensus(majority = 50, distance = 50, transient = 20, holding = 40)
    transient_higher = consensus(majority = 50, distance = 50, transient = 50, holding = 40)
    holding_lower = consensus(majority = 50, distance = 50, transient = 35, holding = 25)
    holding_higher = consensus(majority = 50, distance = 50, transient = 35, holding = 55)
...
def analyse_switching():
    ...
    plt.title("Cross-inhibition model with zealots")    
    plt.xlabel('Amount of zealots Z = Zx + Zy')
    plt.ylabel('Probability of consensus switching')
    plt.legend()
    fig.savefig('../all_switches_new_zealots.png')
    plt.close()  
