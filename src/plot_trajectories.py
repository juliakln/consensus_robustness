...
def plot_consensus():
   ...
   file_x = '/Users/juliaklein/Documents/consensus_robustness/data/traj_consensus_speciesx.txt'
   file_y = '/Users/juliaklein/Documents/consensus_robustness/data/traj_consensus_speciesy.txt'
   file_u = '/Users/juliaklein/Documents/consensus_robustness/data/traj_consensus_speciesu.txt'
...
#     plt.close()   
   ...
   plt.plot(time, allx, 'r', label = r'$X + Z_{X}$')
   plt.plot(time, ally, 'b', label = r'$Y + Z_{Y}$')
   plt.plot(time, u, color = 'darkgrey', label = r'$U$')
   plt.ylim(0,100)
   plt.xlabel('Time (minutes)')
   plt.ylabel('Number of individuals')
   plt.legend()
   fig.savefig('/Users/juliaklein/Documents/consensus_robustness/figures/trajectories_consensusfont.png')
   plt.close()    

def plot_switching():

    file_x = '/Users/juliaklein/Documents/consensus_robustness/data/traj_switching_speciesx.txt'
    file_y = '/Users/juliaklein/Documents/consensus_robustness/data/traj_switching_speciesy.txt'
    file_u = '/Users/juliaklein/Documents/consensus_robustness/data/traj_switching_speciesu.txt'
    ...
    plt.ylabel('Number of individuals')
    plt.legend()
    fig.savefig('/Users/juliaklein/Documents/consensus_robustness/figures/trajectories_switchingfont.png')
    plt.close()    


def plot_indecision():

    file_x = '/Users/juliaklein/Documents/consensus_robustness/data/traj_indecision_speciesx.txt'
    file_y = '/Users/juliaklein/Documents/consensus_robustness/data/traj_indecision_speciesy.txt'
    file_u = '/Users/juliaklein/Documents/consensus_robustness/data/traj_indecision_speciesu.txt'
    ...
    plt.ylabel('Number of individuals')
    plt.legend()
    fig.savefig('/Users/juliaklein/Documents/consensus_robustness/figures/trajectories_indecision1font.png')
    plt.close()    
